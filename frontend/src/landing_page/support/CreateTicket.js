    ...
    return ( 
        <div className="container">
            <div className="row mt-5 p-5 mb-5">
                ...
                <div className="col-4 mt-2 p-5 mb-5">
                <h1 className=" "><i className="fa fa-plus-circle" aria-hidden="true"></i>
                    Account Opening
                </h1>
             ...
             <div className="col-4 mt-2 p-5 mb-2">
                ...
                <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>Login</a> <br />
