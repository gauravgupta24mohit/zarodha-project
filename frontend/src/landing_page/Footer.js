    ...
    <footer style={{ backgroundColor: "rgb(240, 240, 240" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col ">
            <img src={process.env.PUBLIC_URL + "/media/images/logo.svg"} alt="Zerodha logo" />
            <p>
          ...
          <div className="col">
            <p> Account </p> <a href="" style={{textDecoration: "none"}}> Open demat account </a> <br />
          ...
          <div className="col">
            <p> Support </p> <a href="" style={{textDecoration: "none"}}> Contact us </a> <br />
          ...
          <div className="col">
            {" "}
            <p> Company </p> <a href="" style={{textDecoration: "none"}}> About </a> <br />
          ...
          <div className="col">
            <p> Quick links </p> <a href="" style={{textDecoration: "none"}}> Upcoming IPOs </a> <br />
        ...
        <div className="mt-5  text-muted" style={{ fontSize: "14px" }}>
          <p>
            ...
            through Zerodha Broking Ltd.–SEBI Registration no.: IN - DP - 431 -
            2019 Registered Address: Zerodha Broking Ltd., #153/154, 4th Cross,
